<template>
  <div id="user_collection">
    ...
    <ul class="content_2">
      <li v-for="(item,index) in user_goods" :key="index"><user-goods-item :data_1="data" :is_up_sell = "btn_index" :data="item"></user-goods-item></li>
    </ul>
    <div class="pager">
          <el-pagination
...
export default {
  ...
  data() {
    return {
      ...
      all_page: 0,
      btn_index: 0,
      url: ["/unusedgoods/user_save_onsell_save?start=","/unusedgoods/user_save_upsell_save?start="]
    }
  },
   components: {
